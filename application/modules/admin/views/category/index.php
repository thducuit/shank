            ...
            <div class="widget">
                <div class="whead">
                    <div class="block-left control">
                        <?php
                            my_select_range(
                                array('name' => 'range', 'id' => 'ddlshowitem' , 'class' => 'combobox ddlFilter', 'data-filter' => url_add_params($params, '/index.php/admin/category')),
                                $params['range']
                            );
                        ?>
                    </div>
                ...
                <table class="aGrid" cellspacing="0" id="GridView1" style="border-collapse: collapse;">
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td class="cellwidth2">
                                <input type="button" data-delete-confirm data-href='<?php echo url_add_params($expand_params, '/index.php/admin/category/delete')?>' class="tooltip btgrid delete" title="Xóa"  />
                                <input type="button" data-href='<?php echo url_add_params($expand_params, '/index.php/admin/category/edit')?>' class="tooltip btgrid edit" title="Sửa" />
                            </td>
                            <td class="cellwidth1">
