        ...
        <div id="content" class="con">
            ...
            <div class="section">
                <div class="phoneBox treeview" id="navigation">
                    <ul>
                        <li class="first"><a href="index.html">ホームページ<span>Home</span></a></li>
                        <li class="collapsable"><a href="javascript:;">会社概要<span>About Us</span></a>
                            <ul>
                        ...
                        <li class="collapsable"><a href="javascript:;">製品<span>Product</span></a>
                            <ul>
                        ...
                        <li class="last"><a href="sitemap.html">サイトマップ<span>Site Map</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
